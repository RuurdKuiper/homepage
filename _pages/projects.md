...
<div class="project-list">
  <article class="project-card">
    <div class="project-media">
      <img src="/images/projects/lad.png" alt="Illustration for the LAD project">
    </div>
    <div class="project-body">
      <div class="project-header">
        <h3>LAD: LoRA-Adapted Diffusion</h3>
        <span class="project-label">Academic</span>
      </div>
  ...
  <article class="project-card">
    <div class="project-media">
      <img src="/images/projects/radiology-llms.png" alt="Illustration for the Radiology LLMs project">
    </div>
    <div class="project-body">
      <div class="project-header">
        <h3>Radiology LLMs</h3>
        <span class="project-label">Academic</span>
      </div>
  ...
  <article class="project-card">
    <div class="project-media">
      <img src="/images/projects/shap-sum.png" alt="Illustration for the SHAP Sum project">
    </div>
    <div class="project-body">
      <div class="project-header">
        <h3>SHAP Sum</h3>
  ...
  <article class="project-card">
    <div class="project-media">
      <img src="/images/projects/inspect-sr.svg" alt="Illustration for the Inspect-SR project">
    </div>
    <div class="project-body">
      <div class="project-header">
        <h3>Auto-INSPECT-SR</h3>
        <span class="project-label">Academic</span>
      </div>
  ...
  <article class="project-card">
    <div class="project-media">
      <img src="/images/projects/ehr-to-structured.png" alt="Screenshot for the EHR-to-struct project">
    </div>
    <div class="project-body">
      <div class="project-header">
        <h3>EHR-to-struct</h3>
...
<div class="project-list">
  <article class="project-card">
    <div class="project-media">
      <img src="/images/projects/tinitopo.png" alt="Illustration for the TiniTopo project">
    </div>
    <div class="project-body">
      <div class="project-header">
        <h3>TiniTopo</h3>
  ...
  <article class="project-card">
    <div class="project-media">
      <img src="/images/projects/rise-or-ruin.png" alt="Illustration for the Rise or Ruin project">
    </div>
    <div class="project-body">
      <div class="project-header">
        <h3>Rise or Ruin</h3>
  ...
  <article class="project-card">
    <div class="project-media">
      <img src="/images/projects/homie.png" alt="Illustration for the Homie project">
    </div>
    <div class="project-body">
      <div class="project-header">
        <h3>Homie</h3>
...
- [Full repositories list](https://github.com/RuurdKuiper?tab=repositories)
- [Full Hugging Face spaces list](https://huggingface.co/Ruurd/spaces)
